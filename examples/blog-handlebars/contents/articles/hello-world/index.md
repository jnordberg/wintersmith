...
Welcome to your new blog! This is the default hb-bootstrap-blog template with RSS, pagination and an archive. There are other templates available -- run `wintersmith new --help` to list them.
